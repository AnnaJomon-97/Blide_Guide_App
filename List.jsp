<%-- 
    Document   : List
    Created on : Jun 5, 2021, 6:37:03 PM
    Author     : HP
--%>
...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_schedule sc inner join tbl_route r on r.route_id=sc.route_id inner join tbl_location l on r.location_from=l.location_id inner join tbl_district d on d.district_id=l.district_id";
